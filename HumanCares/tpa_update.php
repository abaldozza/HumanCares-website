...
$id = $_GET['updateid'];
$sql = "Select * from `tree_planting_admin` where treepid=$id";
...
if (isset($_POST['submit'])) {
    ...
    $sql = "update `tree_planting_admin` set treepid=$id, location='$location', date='$date', time='$time' where treepid=$id";
    $result = mysqli_query($con, $sql);
    if ($result) {
